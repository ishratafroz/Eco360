...
public class SignUP extends AppCompatActivity implements View.OnClickListener{
    ...
    private void userRegister() {
        ...
        if(email.isEmpty())
        {
            signupe2.setError("Enter an email address"); signupe2.requestFocus(); return;
        }
        if(name.isEmpty())
        {
            signupe1.setError("Please enter your name"); signupe1.requestFocus(); return;
        }
        if(!android.util.Patterns.EMAIL_ADDRESS.matcher(email).matches())
        {
            signupe2.setError("Enter a valid email address"); signupe2.requestFocus(); return;
        } if(password.isEmpty())
        {
            signupe3.setError("Enter a password"); signupe3.requestFocus(); return;
        }
        if(password.length()<6)
        {
            signupe3.setError("Minimum length of a password should be 6"); signupe3.requestFocus();return;
        }
